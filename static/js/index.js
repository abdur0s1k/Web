...
slides.forEach((slide, index) => {
  switch (index) {
    case 0:
      slide.style.backgroundImage = "url('/static/images/content/recom.jpg')";
      break;
    case 1:
      slide.style.backgroundImage = "url('/static/images/content/recom-2.jpg')";
      break;
    case 2:
      slide.style.backgroundImage = "url('/static/images/content/recom-3.jpg')";
      break;
    default:
...
// Закрытие панели входа по "крестику"
closePanelButton?.addEventListener("click", function () {
  hidePanel(loginPanel);
});

// Закрытие панели профиля по "крестику"
...
closeRegistrationModalButton?.addEventListener("click", function () {
  ...
  showPanel(loginPanel);  // Возвращаем пользователя обратно к панели входа после закрытия окна регистрации
});
