...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let productFound = false; // Переменная для проверки, был ли найден товар

  allProducts.forEach(product => {
    if (product.dataset.productId === productId) {
      product.style.display = 'block'; // Показываем нужный товар
      productFound = true; // Устанавливаем флаг, что товар найден
    } else {
      product.style.display = 'none'; // Скрываем все остальные товары
    }
  });

  // Если товар не найден, выводим сообщение на экран
  if (!productFound) {
    const notFoundMessage = document.createElement('p');
    notFoundMessage.textContent = 'Товар не найден';
